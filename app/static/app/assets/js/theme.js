  ...
  if (window.List) {
    ...
    if (lists.length) {
      lists.forEach(function (el) {
        ...
        var paginationButtonNext = el.querySelector('[data-list-pagination.html="next"]');
        var paginationButtonPrev = el.querySelector('[data-list-pagination.html="prev"]');
        ...
        } // numbering pagination.html


        if (options.pagination) {
          el.querySelector('.pagination.html').addEventListener('click', function (e) {
...
var marketShareEcommerceInit = function marketShareEcommerceInit() {
  var ECHART_PRODUCT_SHARE = '.echart-product.py-share';
